...
class NetworkManager: NSObject {
    ...
    private let peopleURL = baseURL + "people"
//    private let planetURL = baseURL + "planet"
    
    private override init() {}
    
    
    func getPeople(completed: @escaping (Result<[People], APError>) -> Void) {
        ...
        let task = URLSession.shared.dataTask(with: URLRequest(url: url)) { data, response, error in
            ...
            do {
                ...
                let decodedResponse = try decoder.decode(PeopleResponse.self, from: data)
    ...
    func getPlanet(_ planetURL: String, completed: @escaping (Result<Planet, APError>) -> Void) {
    ...
    func getVehicle(_ planetURL: String, completed: @escaping (Result<Vehicle, APError>) -> Void) {
        guard let url = URL(string: planetURL) else {
            completed(.failure(.invalidURL))
            return
        }
